...
/////////////////
const BotName = 'Idzeroid☄'; 
const instagram = 'https://instagram.com/haryreza'; 
const telegram = 'https://t.me/idzeroidsupport'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@haryreza')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@haryreza`)
})
